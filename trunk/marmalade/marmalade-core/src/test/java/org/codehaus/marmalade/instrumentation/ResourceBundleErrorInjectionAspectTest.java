 ...
 * @author jdcasey
 */
public class ResourceBundleErrorInjectionAspectTest
    extends TestCase
{
        ...
        ModelBuilderException
    {
        String testScript = "<?xml version=\"1.0\"?>\n"
            + "<testFailure xmlns=\"marmalade:org.codehaus.marmalade.instrumentation.testExceptionPkg.TestFailureTaglib\"/>";
        ...
        catch ( MarmaladeExecutionException e )
        {
            ...
            assertTrue( message.indexOf( "This is a test exception" ) > -1 );
        }
    }
}