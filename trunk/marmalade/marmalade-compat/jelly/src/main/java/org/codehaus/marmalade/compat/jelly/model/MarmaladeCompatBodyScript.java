...
public class MarmaladeCompatBodyScript implements Script
{
    ...
    public MarmaladeCompatBodyScript( JellyCompatMarmaladeTag owner,
        MarmaladeExecutionContext context, ExpressionEvaluator el,
        List bodyItems )
    {
        this.owner = owner;
        ...
        throws JellyTagException
    {
        ...
        try
        {
            oldOut = ( XMLOutput ) context.getVariable( JellyCompatConstants.JELLY_XML_OUTPUT_CONTEXT_VARIABLE,
                    null );
            ...
            for ( Iterator it = bodyItems.iterator(  ); it.hasNext(  ); )
            {
                ...
                else
                {
                    ...
                    String content = String.valueOf( el.evaluate( expression,
                                context.unmodifiableVariableMap(  ),
                                Object.class ) );
                    ...
                    {
                        throw new JellyCompatUncheckedException( "Error writing to XMLOutput.",
                            e );
                    }
                }
            }
