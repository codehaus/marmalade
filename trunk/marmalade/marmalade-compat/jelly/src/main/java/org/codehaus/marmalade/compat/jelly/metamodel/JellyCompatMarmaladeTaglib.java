...
package org.codehaus.marmalade.compat.jelly.metamodel;

import org.apache.commons.jelly.Jelly;
import org.apache.commons.jelly.TagLibrary;
import org.codehaus.marmalade.compat.jelly.JellyCompatUncheckedException;
import org.codehaus.marmalade.compat.jelly.model.JellyCompatMarmaladeTag;
        ...
        synchronized ( this )
        {
            ...
            if ( tlib == null )
            {
                try
                {
                    ...
                    Class tlibCls = cloader.loadClass( tlibClass );
