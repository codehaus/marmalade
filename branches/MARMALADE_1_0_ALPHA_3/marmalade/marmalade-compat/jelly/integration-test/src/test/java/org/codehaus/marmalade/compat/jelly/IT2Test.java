 ...
 * @author jdcasey
 */
public class IT2Test extends AbstractIntegrationTestRunner {
    
    public void testRunJellyDefineBasedScript() throws MarmaladeParsetimeException, MarmaladeModelBuilderException, MarmaladeExecutionException {
        String testResource = "it2.jelly";
