...
public final class MarmaladeControlDefinitions
{
    ...
    /**
     * control attribute to allow specification of the expression evaluator via
     * processing instruction.
     */
    public static final String EXPRESSION_EVALUATOR_ATTRIBUTE = "el";

    /**
     * control attribute used as the default flag to preserve body whitespace.
     */
    public static final String PRESERVE_BODY_WHITESPACE_ATTRIBUTE = "preserve-whitespace";

    /**
     * control PI to allow specification of the expression evaluator via
     * processing instruction.
     */
