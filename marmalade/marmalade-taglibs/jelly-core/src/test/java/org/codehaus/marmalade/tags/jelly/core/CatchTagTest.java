...
public class CatchTagTest extends TestCase
{
        ...
        throws MarmaladeExecutionException
    {
        ...
        attrs.addAttribute( "", CatchTag.VAR_ATTRIBUTE, "exception" );
        attrs.addAttribute( "", CatchTag.CLASS_ATTRIBUTE, "java.lang.UnsupportedOperationException" );
        ...
        throws MarmaladeExecutionException
    {
        ...
        attrs.addAttribute( "", CatchTag.VAR_ATTRIBUTE, "exception" );
        attrs.addAttribute( "", CatchTag.CLASS_ATTRIBUTE, "java.lang.IllegalArgumentException" );
